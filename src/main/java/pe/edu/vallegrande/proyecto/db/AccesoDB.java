...
public class AccesoDB {
	...
	public static Connection getConnection() throws SQLException {
        ...
        String urlDB = "jdbc:sqlserver://localhost:1433;databaseName=carbon_blanco;encrypt=true;TrustServerCertificate=True;";
		String user="sa";
		String pass = "admin";
		try {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Buena Proplayer lo lograstes ingresastes a Carbon_Blanco");
			cn.close();
		} catch (Exception e) {
			e.printStackTrace();
		}
